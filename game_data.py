...
# ---------- 1. ГЕРОЙ (противоядие) ----------
hero_cost = {
    1: 0, 2: 100, 3: 200, 4: 300, 5: 500, 6: 700, 7: 900, 8: 1100, 9: 1300, 10: 1500,
    ...
    141: 140000000, 142: 144000000, 143: 148000000, 144: 152000000, 145: 156000000, 146: 160000000, 147: 164000000, 148: 168000000, 149: 172000000, 150: 179000000
}
hero_cum = {0: 0, 1: 0}  # ← ДОБАВЛЕН КЛЮЧ 1
...
skill_cost = {
    ...
    31: 19900, 32: 21400, 33: 22900, 34: 24400, 35: 25900, 36: 27400, 37: 28900, 38: 30400, 39: 31900, 40: 33400
}
skill_cum = {0: 0, 1: 0}
for i in range(2, 41):
...
# ---------- 6. ПРОБУЖДЕНИЕ (фрагменты) ----------
awakening_cost = {
    0: 50, 1: 10, 2: 10, 3: 10, 4: 10,
    5: 20, 6: 20, 7: 20, 8: 20, 9: 30,
    10: 30, 11: 30, 12: 30, 13: 40, 14: 40,
    15: 40, 16: 40, 17: 50, 18: 50, 19: 50,
    20: 50, 21: 60, 22: 60, 23: 60, 24: 60,
    25: 70, 26: 70, 27: 70, 28: 70, 29: 100,
    30: 100, 31: 100, 32: 150, 33: 150, 34: 150,
    35: 200, 36: 200, 37: 200, 38: 200, 39: 200
}
awakening_cum = {0: 0}
for lvl in range(1, 41):
    awakening_cum[lvl] = awakening_cum[lvl - 1] + awakening_cost.get(lvl - 1, 0)

# ---------- ЗВЁЗДЫ ЭКСКЛЮЗИВНОГО ОРУЖИЯ ----------
star_weapon_step = {
    0.2: 30, 0.4: 2, 0.6: 2, 0.8: 2, 1.0: 2,
    1.2: 3, 1.4: 3, 1.6: 3, 1.8: 3, 2.0: 3,
    2.2: 4, 2.4: 4, 2.6: 4, 2.8: 4, 3.0: 4,
    3.2: 6, 3.4: 6, 3.6: 6, 3.8: 6, 4.0: 6,
    4.2: 8, 4.4: 8, 4.6: 8, 4.8: 8, 5.0: 8,
...
star_weapon_step[0] = 0
star_weapon_levels = star_levels
star_weapon_cum = {0: 0}
cum_w = 0
for s in star_weapon_levels:
    if s == 0:
        continue
    cum_w += star_weapon_step[s]
    star_weapon_cum[s] = cum_w
