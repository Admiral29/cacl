...
skill_cum = {0: 0, 1: 0}
for i in range(2, 41):  # расширено до 40
...
# Стоимость перехода с уровня на уровень (ключ = текущий уровень)
awakening_cost = {
...
awakening_cum = {0: 0}
for lvl in range(1, 41):  # целевой уровень от 1 до 40
    awakening_cum[lvl] = awakening_cum[lvl - 1] + awakening_cost.get(lvl - 1, 0)

# ---------- ЗВЁЗДЫ ЭКСКЛЮЗИВНОГО ОРУЖИЯ (отличается первый шаг: 30 вместо 2) ----------
star_weapon_step = {
...
star_weapon_levels = star_levels  # уровни те же
star_weapon_cum = {0: 0}
cum_w = 0
